...
public class MatchController {
    ...
    public String showSelectedMatchTable(@PathVariable String matchNameFormat , Model model){
    ...
    @ResponseBody
    public String addNewMatchRecord(@PathVariable String matchNameFormat , float billMoney , int billType , String billComment , Date billTime , HttpServletResponse response) throws IOException {
        if (billType == 1){
